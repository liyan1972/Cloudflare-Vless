...
// const CFG = { id: '88888888-8888-8888-8888-888888888888', chunk: 128 * 1024, dnPack: 64 * 1024, dnTail: 1024, dnMs: 8, upPack: 32 * 1024, upQMax: 512 * 1024, maxED: 8 * 1024, concur: 1 };
//
// 【预设B：低延迟优先】适合交互型流量、高连接数、混合场景（当前启用）
const CFG = { id: '88888888-8888-8888-8888-888888888888', chunk: 64 * 1024, dnPack: 32 * 1024, dnTail: 512, dnMs: 0, upPack: 16 * 1024, upQMax: 256 * 1024, maxED: 8 * 1024, concur: 1 };
